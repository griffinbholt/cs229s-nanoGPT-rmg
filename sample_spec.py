...
import torch
import tiktoken
from model_quant import GPTConfig, GPT, DEBUG
import time, json

# -----------------------------------------------------------------------------
init_from = 'resume' # either 'resume' (from an out_dir) or a gpt2 variant (e.g. 'gpt2-xl')
out_dir = 'out' # ignored if init_from is not 'resume'
start = "FILE:data/shakespeare/input.txt" # or "<|endoftext|>" or etc. Can also specify a file, use as: "FILE:prompt.txt"
...
print(f'[SPEC]  Generated {tokens_generated} tokens in {t1s-t0s:3f} seconds for {tokens_generated/(t1s-t0s):3f} tok/sec.')